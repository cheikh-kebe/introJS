var protein = "CCG UCG UUG CGC UAC AGC";

protein = protein.replace("CCG", "Proline ");
...
protein = protein.replace("AGC", "Sérine ");
console.log(protein );

var protein ="CCU CGC CGG UAC UUC UCG";
protein = protein.replace("CCU", "Proline ");
protein = protein.replace("UCG", "Sérine ");
